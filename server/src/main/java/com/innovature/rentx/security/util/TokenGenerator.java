...
public class TokenGenerator {
    ...
    public static final class Status {
        ...
        private Status(String data,String roleId ,long time, long expiry) {
            this.data = data;
            this.roleId=roleId;
            this.time = time;
            this.expiry = expiry;
    ...
    public Token create(String purpose, String data,String roleId, Duration expiry) throws IllegalArgumentException {
        ...
        String token = purpose + SEPARATOR + encode(data) + SEPARATOR +encode(roleId)+SEPARATOR + t + SEPARATOR + e + SEPARATOR + r;
    ...
    public Status verify(String purpose, String token, boolean checkExpiry)
        ...
        return new Status(decode(parts[1]), decode(parts[2]),keyTime, keyTime + expiry);
    }
}
